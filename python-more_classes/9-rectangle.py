...
an eval-compatible repr representation, instance tracking, a method to
compare rectangles by area, and a class method to create square rectangles.
"""
...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        "Return the rectangle with greater area, or rect_1 if areas are equal"
